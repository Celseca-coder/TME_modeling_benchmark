#!/usr/bin/env python
"""Spatial distance baseline over all datasets, tasks and schemes.

Feature: per region, distance-based features computed from cell coordinates:
  * mean/median nearest-neighbor distance (same-type & cross-type)
  * mean/median distance to k-th nearest neighbor (same-type & cross-type)
  * (optional) proportion of cells with nearest neighbor of same/different type
All features are calculated within the tissue foreground. Regions missing tissue mask
